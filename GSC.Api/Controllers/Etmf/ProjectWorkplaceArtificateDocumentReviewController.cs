...
namespace GSC.Api.Controllers.Etmf
{
    ...
    public class ProjectWorkplaceArtificateDocumentReviewController : BaseController
    {
        ...
        public IActionResult GetMaxDueDate(int documentId)
        {
            ...
            return Ok(_projectWorkplaceArtificateDocumentReviewRepository.GetMaxDueDate(documentId));
        }
        ...
        {
            if (documentId <= 0) return BadRequest();
            return Ok(_projectWorkplaceArtificateDocumentReviewRepository.SkipDocumentReview(documentId));
        }
    }
}