...
namespace GSC.Respository.Master
{
    public class SiteTeamRepository : GenericRespository<SiteTeam>, ISiteTeamRepository
    {
        ...
        {
            var data = _projectRightRepository.FindByInclude(x => x.ProjectId == projectid && x.IsReviewDone, x => x.role).
        ...
        {
            var data = _projectRightRepository.FindByInclude(x => x.ProjectId == projectid && x.RoleId == roleId && x.IsReviewDone, x => x.User).
