...
namespace GSC.Respository.EditCheckImpact
{
    public interface IEditCheckImpactRepository : IGenericRepository<ScreeningTemplate>
    {
        ...
        List<EditCheckTargetValidationList> VariableValidateProcess(int screeningEntryId, int screeningTemplateId, string value, int projectDesignTemplateId, int projectDesignVariableId, List<EditCheckIds> editCheckIds, bool isQueryRaise, int screeningVisitId, int? projectDesignVisitId);
